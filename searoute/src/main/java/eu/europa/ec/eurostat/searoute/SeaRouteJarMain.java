...
public class SeaRouteJarMain {
	...
	public static void main(String[] args) throws Exception {
		...
		options.addOption(Option.builder("nonIRTC").desc("Optional. Set to '1' to allow trips outside the IRTC. Default: '0'.")
				.hasArg().argName("0 or 1").build());
		...
		String irtc = cmd.getOptionValue("nonIRTC");   if(irtc == null) irtc = "0";

		System.out.println("Suez is "+suez+", irtc is "+irtc);
		...
		for( HashMap<String, String> o : data ) {
			...
			//compute route
			Feature f = sr.getRoute(oLon, oLat, dLon, dLat, "1".equals(suez), "1".equals(panama), "1".equals(irtc));
